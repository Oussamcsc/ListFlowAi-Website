...
const CookieConsent = () => {
  ...
  const handlePreferencesSave = (preferences: CookiePrefs) => {
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="fixed bottom-6 left-6 z-50 w-4/5 h-auto rounded-2xl bg-card shadow-2xl max-w-[300px] border border-border"
            style={{
          ...
          >
            <div className="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
              ...
              {/* Title */}
              <h5 className="text-sm font-semibold mb-2 text-left mr-auto text-foreground font-sora">
                Your privacy is important to us
              </h5>

              {/* Description */}
              <p className="w-full mb-4 text-sm text-justify text-muted-foreground leading-relaxed">
                ...
                <button
                  ...
                  className="text-primary font-semibold transition-colors hover:text-primary/80 underline underline-offset-2 cursor-pointer"
                >
                  Privacy Policy
                </button>
              </p>
              ...
              <button
                onClick={handleMoreOptions}
                className="mb-2 text-sm mr-auto text-muted-foreground cursor-pointer font-semibold transition-colors hover:text-foreground hover:underline underline-offset-2"
              >
                More Options
              </button>
              ...
              <button
                ...
                className="absolute font-semibold right-6 bottom-6 cursor-pointer py-2 px-8 w-max text-sm rounded-lg transition-colors text-primary-foreground bg-primary hover:bg-primary/90"
                type="button"
              >
                Accept
              </button>
